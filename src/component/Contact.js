...
const Contact = () => {
  const submitForm = (values) => {
    ...
    var body =
      ...
      values.mobileNo +
      '</td></tr></table><p style="font-weight:700">Best regards,<br>Your Team at Omkar Nature Farm</p></div></body></html>';
  ...
  return (
    <>
      <MetaTags>
        <title>Resort near Kelve Beach | Raj Resort</title>
        <meta title="Resort near Kelve Beach | Raj Resort" />
        <meta
          name="description"
        ...
        <meta property="og:title" content="Resort near Kelve Beach | Raj Resort" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.raj-resort.in/" />
        <meta
          property="og:description"
          content="Escape to serenity at our Resort near Kelve Beach. Experience relaxation, adventure, and stunning views. Book your stay now for an unforgettable retreat!"
        />
        <meta
          property="og:image"
                ...
                <div className="contact-title">
                  <div className="section-title">
                    ...
                    <div className="con-head">
                      <h1 className="specialh1">Resort Near Kelve Beach </h1>
                      <h2>Contact us for your next visit</h2>
                    </div>
                  </div>
            ...
            <div className="row">
              ...
              <div className="col-lg-4">
                <div className="info-box">
                  {/* <img src="img/contact-logo.png" alt="Resort near Kelve Beach " /> */}
                  <ul>
                    <li>
                      <i className="fa fa-map-marker"> </i>
                      Kelwa Rd, Mangelwada, Kelwa Road, Maharashtra 401401,
                      India
                    </li>
                    <li>
                      <i className="fa fa-phone"></i>+91 9890165286{" "}
                    </li>
                    <li>
                      <i className="fa fa-phone"></i>+91 9225102497{" "}
                    </li>
                    <li>
                      <i className="fa fa-envelope"></i>
                      rajresortbooknow@gmail.com
                    </li>
                    <li>
                      <i className="fa fa-clock-o"></i>Everyday: 09:00 am to
                      10:00 pm
                    </li>
                  </ul>
