        ...
        <div>
            <div class="page-content ">
                <div
                    ...
                    style={{ backgroundImage: `linear-gradient(to right, rgba(10, 9, 9, 0.5), rgb(0, 0, 0, 0.5)),url(${eventbg})`, backgroundPosition: "50% -160px", backgroundAttachment: "fixed" }}
                        ...
                        <div className="col-md-4 col-sm-4">
                            <div className="wt-icon-box-wraper center bdr-1 bdr-gray-light bdr-solid m-b30 p-a20 hover-box-effect  v-icon-effect">
                                ...
                                <div className="icon-content">
                                    ...
                                    <p>We are the venue of countless corporate seminars conventions and event.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-4 col-sm-4">
                            <div className="wt-icon-box-wraper center bdr-1 bdr-gray-light bdr-solid m-b30 p-a20 hover-box-effect  v-icon-effect">
                                ...
                                <div className="icon-content">
                                    ...
                                    <p>We accommodated special parking area for your convenience </p>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-4 col-sm-4">
                            <div className="wt-icon-box-wraper center bdr-1 bdr-gray-light bdr-solid m-b30 p-a20 hover-box-effect  v-icon-effect">
                                ...
                                <div className="icon-content">
                                    ...
                                    <p>The resort in your budget that you won't find anywhere else.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-4 col-sm-4">
